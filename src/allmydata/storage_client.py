...
class NativeStorageClientDescriptor:
    ...
    def get_nickname(self):
        """Return a unicode string with my nickname, or None if I don't have
        one. Nicknames are self-generated and provided by the storage server,
        so they offer no security properties at all."""
    ...
    def get_version_info(self):
        """Return a version-feature-dictionary, describing what the server
        claims to be capable of doing. For native storage servers, this is
        generated by calling remote_get_version."""
        if self.rref:
            return rref.version
        return None
