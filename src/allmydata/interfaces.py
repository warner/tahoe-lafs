...
class RIStorageServer(RemoteInterface):
    ...
    def add_lease(storage_index=StorageIndex,
        ...
        renew_secret and cancel_secret are ignored as of Tahoe-LAFS v1.X.0,
    ...
    def renew_lease(storage_index=StorageIndex, renew_secret=LeaseRenewSecret):
        ...
        renew_secret is ignored as of Tahoe-LAFS v1.X.0, but for backward
        ...
        Note that as of Tahoe-LAFS v1.X.0, the lease database does not retain
