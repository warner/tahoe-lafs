...
def get_package_versions_and_locations():
    import warnings
    from allmydata._auto_deps import package_imports, global_deprecation_messages, deprecation_messages, \
...
def cross_check(pkg_resources_vers_and_locs, imported_vers_and_locs_list):
    ...
    from allmydata._auto_deps import not_import_versionable, ignorable
